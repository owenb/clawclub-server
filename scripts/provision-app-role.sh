...
# both run the app AND manage the schema (CREATE on the database so it
# can create app-owned schemas, plus USAGE/CREATE on schema public and
...
select format('grant connect, create on database %I to %I', :'database_name', :'app_role') \gexec
